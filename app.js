    ...
    stops: [
      {
        ...
        notes:
          "行李提領與交通轉乘。可先在到達層補水、換日幣，買點心或手機網卡，確認隔天租車與住宿資訊。",
        extra: "",
      },
      {
        id: "d1-2",
        ...
        notes:
          "晚餐。串燒小份量好分食，必點經典雞腿、雞皮與蔬菜串，先點基本盤再加點。",
        extra: "",
      },
      {
        id: "d1-3",
  ...
  },
  {
    ...
    stops: [
      ...
      },
      {
        ...
        notes:
          "經典美式速食。必喝 A&W root beer，搭漢堡或炸物。",
        extra: "",
      },
      {
        id: "d2-7",
